  ...
  return (
    <div style={S.page}>
      ...
      >
        ...
        <p style={S.leftSub}>
          Join thousands of students making smarter
          college decisions with real reviews and
          AI-powered insights.
        </p>
      ...
      <div style={S.right}>
        ...
        >
          <p style={S.topLabel}>Get started</p>
          <h2 style={S.heading}>Create your account</h2>
          <p style={S.subheading}>Unlock all features — free forever.</p>
